...
let matn = "bugun biz js da string metodlarini o'rganamaiz"
...
let str17 = str16.includes('web', 10); // bu yerdagi "10" raqami qidiruvni 10 chi indexdan boshlang degan ma'noni bildiradi
console.log(str17);
