...
/* 
 String Methods
    ...
    matchAll() -- match() massivga joylashtirgan qiymatlarni iteratsiya qiladi ya'ni massivdan chiqaradi.
...
let str12 = 'Web dasturchi: js, reactjs, vuejs, angularjs ni o\'rganishi kerak';
const str13 = str12.matchAll(/js/gi); // Bu qatordagi ( /..../gi ) kodi bir vaqtda katta kichik moslik nechta bo'lsa hammasini qaytaradi
console.log(str13);
